...
####################################### Split the dfs into training (feat, labels) and testing (feat, labels) datasets
...
''' Function to create a function that evaluates our model using our actual and predicted data'''
...
LG_metrics.to_csv(path+"LG_metrics_df.csv", index= False)
LG_metrics
...
''' Functiona for creating a function that evaluates our model using our actual and predicted data'''
def evaluate(LG_combo_model, labels_test, labels_pred, cf= True, show_results=True):
  report = classification_report(labels_test, labels_pred, output_dict = True)
  if cf == True:
    cm = confusion_matrix(labels_test, labels_pred, labels=RF_combo_model.classes_)
...
RF_metrics.to_csv(path+"RF_metrics_df.csv", index= False)
RF_metrics
...
'''Function for creating a function that evaluates our model using our actual and predicted data'''
def evaluate(LG_combo_model, labels_test, labels_pred, cf= True, show_results=True):
  report = classification_report(labels_test, labels_pred, output_dict = True)
  if cf == True:
    cm = confusion_matrix(labels_test, labels_pred, labels=GB_combo_model.classes_)
...
GB_metrics.to_csv(path+"GB_metrics_df.csv", index= False)
GB_metrics
